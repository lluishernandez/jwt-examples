...
USERS = {
    'user1': {'aud': 'proxy', 'prf': 'accountant-full'},
    'user2': {'aud': 'proxy', 'prf': 'accountant-simple'},
    'user3': {'aud': 'proxy', 'prf': 'nutritionist'},
    'user4': {'aud': 'proxy', 'prf': 'no-access'},
}
